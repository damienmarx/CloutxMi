...
```bash
git clone https://github.com/No6love9/degensden-Fixed.git
cd degensden-Fixed
```
...
Create a systemd service file `/etc/systemd/system/degensden.service`:
...
Type=simple
User=ubuntu
WorkingDirectory=/home/ubuntu/degensden-Fixed
